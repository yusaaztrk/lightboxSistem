        ...
        <div className="p-6 md:p-10 space-y-10 md:space-y-12 pb-8 md:pb-32">
            ...
            <div className="space-y-10 md:space-y-12 px-1 md:px-2">
                    ...
                    <div className="space-y-2 md:space-y-3">
                        {availableBackings.length > 0 ? (
                            availableBackings.map(opt => (
                                <button key={opt.id} onClick={() => updateConfig('backplate', opt.materialType)} className={`w-full py-4 md:py-5 px-6 md:px-8 rounded-2xl text-[10px] font-black text-left transition-all border flex items-center justify-between ${config.backplate === opt.materialType ? 'border-indigo-500 bg-indigo-500/10 text-white shadow-lg' : 'border-white/5 text-gray-500 hover:border-white/10'}`}>
                                    {opt.displayName}
                ...
                <div className="p-4 md:p-6 bg-indigo-600/5 border border-indigo-500/10 rounded-[2rem] shadow-inner mt-4">
                    {breakdown ? (
                        <button onClick={() => setIsOrderModalOpen(true)} className="w-full bg-white text-black font-black py-5 md:py-6 rounded-2xl hover:bg-gray-200 transition-all flex items-center justify-center gap-3 md:gap-4 shadow-2xl uppercase tracking-tighter text-base md:text-lg group active:scale-[0.98]">
    ...
    return (
        <>
            ...
            <div className="md:hidden min-h-screen w-full bg-[#050507] text-gray-200 font-sans overflow-y-auto overflow-x-hidden">
                    ...
                    <div className="flex justify-between items-center z-10 bg-white/[0.03] p-4 rounded-2xl border border-white/5 backdrop-blur-3xl shadow-2xl">
                        <div className="flex items-center gap-3">
                            ...
                            <div onClick={() => navigate('/')} className="cursor-pointer">
                                <img src="/logo_new.png" alt="Lightbox Master" className="h-12 w-auto object-contain rounded-lg" />
                            </div>
                        </div>
                ...
                <div className="bg-[#08080a] border-t border-white/5 mt-8">
                ...
                <div className="flex-1 relative p-8 flex flex-col overflow-y-auto custom-scrollbar">
                    <div className="flex justify-between items-center mb-8 z-10 bg-white/[0.03] p-6 rounded-[2.5rem] border border-white/5 backdrop-blur-3xl shadow-2xl">
                        <div className="flex items-center gap-5">
                            ...
                            <div onClick={() => navigate('/')} className="cursor-pointer">
                                <img src="/logo_new.png" alt="Lightbox Master" className="h-14 w-auto object-contain rounded-xl" />
                            </div>
                        </div>
